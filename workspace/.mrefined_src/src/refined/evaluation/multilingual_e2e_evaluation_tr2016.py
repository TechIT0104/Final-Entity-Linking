...
def main():
    ...
    parser.add_argument('--validate_gold_offsets', action='store_true',
                        help="Filter out gold mentions with offset/text mismatch before scoring")
    ...
    for lang in languages:
        ...
        metrics_el = evaluate_on_docs(refined=refined, docs=dataset_docs, dataset_name=dataset_name, 
                                    ...
                                    validate_gold_offsets=cli_args.validate_gold_offsets)
        print('*****************************\n\n')
