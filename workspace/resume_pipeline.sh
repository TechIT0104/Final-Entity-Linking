#!/bin/bash
# ======================================================================
# MVD Pipeline — RESUME from Stage 2 (Teacher)
# Stages 1a/1b already completed (train_cand.jsonl, valid_cand.jsonl exist)
# ======================================================================
...
LOG=/home/kmpooja/entity_linking/mvd_resume_${TIMESTAMP}.log
...
log "============================================================"
log "   MVD Pipeline RESUME — from Stage 2 (Teacher)"
log "============================================================"
...
print(",".join(free) if free else "0")
PYEOF
)
[ -z "$FREE_GPUS" ] && FREE_GPUS="3"
...
log ""
log "============================================================"
log "   MVD RESUME Pipeline — COMPLETE"
log "   Finished: $(date)"
log "   Full log: $LOG"
log "============================================================"
