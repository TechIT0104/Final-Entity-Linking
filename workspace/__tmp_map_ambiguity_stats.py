...
for lang in ["de","es","fr","it"]:
    ...
    tot=hard=hit=hit_h=miss=miss_h=multi=multi_h=one=one_h=0
    for fp in files:
    ...
    print(lang, "tot",tot,"hard",hard,"hit",hit,"miss",miss,"one",one,"multi",multi,"hit_h",hit_h,"miss_h",miss_h,"one_h",one_h,"multi_h",multi_h)
PY
'"""
